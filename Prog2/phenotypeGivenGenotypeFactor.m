...
%how many genotypes given the #alleles is n choose 2 + n
% the number of alleles are the number of rows in alphaList

[ngenotypes, ncols] = size(alphaList);
alphaList;
%genotypes=nchoosek(nalleles,2) + nalleles
...
phenotypeFactor.card= [2, ngenotypes];
...
for i=1:prod(phenotypeFactor.card)
    phenotypeFactor.val(i)=alphas(i);
end
