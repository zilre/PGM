...
for i=1:length(affectedAlphas)
  unaffectedAlphas(i)=1-affectedAlphas(i);
...
for i=1:prod(phenotypeFactor.card)
    ...
    genotype_num;
    if assignment(1) == 1
        phenotypeFactor.val(i) = affectedAlphas( genotype_num );
    else
        phenotypeFactor.val(i) = unaffectedAlphas( genotype_num );
    end
end
